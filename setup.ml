...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6afb9b568dfe7dfa4881b96717e6e68e) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_qc_parser",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_qc_parser", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("core_kernel",
                               Some (OASISVersion.VEqual "113.33.03"));
                           FindlibPackage
                             ("menhirLib",
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_qc_parser.ml"});
               Test
                 ({
                     cs_name = "test_qc_parser";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "IW\018\005\150\026\020\004n\191x\184\130\217\018H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
