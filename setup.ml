...
(* OASIS_START *)
(* DO NOT EDIT (digest: d5061d0302bba02469198e313ce8f1a8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "Compiler for Tiger language from \"Modern Compiler Implementation\nin ML\"";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some ":\165\219\246\179\019\185\192\142\214\137Ke2m\188";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
